...
# Example usage
file_path = 'node.txt'  # Make sure this is the correct path
bodies_coords = extract_bodies_coordinates(file_path)



print (bodies_coords[0])
print (type(bodies_coords[0][0]))
...
while i< len(bodies_coords):

	vertices = numpy.zeros([8, 3], 'd')
	#       - sommet 1
	vertices[0, 0]=bodies_coords[i][0][0]
	vertices[0, 1]=bodies_coords[i][0][1]
	vertices[0, 2]=bodies_coords[i][0][2]
	#       - sommet 2
	vertices[1, 0]=bodies_coords[i][1][0]
	vertices[1, 1]=bodies_coords[i][1][1]
	vertices[1, 2]=bodies_coords[i][1][2]
	#       - sommet 3
	vertices[2, 0]=bodies_coords[i][2][0]
	vertices[2, 1]=bodies_coords[i][2][1]
	vertices[2, 2]=bodies_coords[i][2][2]
	#       - sommet 4
	vertices[3, 0]=bodies_coords[i][3][0]
	vertices[3, 1]=bodies_coords[i][3][1]
	vertices[3, 2]=bodies_coords[i][3][2]
	#       - sommet 5
	vertices[4, 0]=bodies_coords[i][4][0]
	vertices[4, 1]=bodies_coords[i][4][1]
	vertices[4, 2]=bodies_coords[i][4][2]
	#       - sommet 6
	vertices[5, 0]=bodies_coords[i][5][0]
	vertices[5, 1]=bodies_coords[i][5][1]
	vertices[5, 2]=bodies_coords[i][5][2]
	#       - sommet 7
	vertices[6, 0]=bodies_coords[i][6][0]
	vertices[6, 1]=bodies_coords[i][6][1]
	vertices[6, 2]=bodies_coords[i][6][2]
	#       - sommet 8
	vertices[7, 0]=bodies_coords[i][7][0]
	vertices[7, 1]=bodies_coords[i][7][1]
	vertices[7, 2]=bodies_coords[i][7][2]
	#    * connectivite des faces
	faces = numpy.zeros([12, 3], 'i')
	faces[ 0, 0]=1; faces[ 0, 1]=2; faces[ 0, 2]=3
	faces[ 1, 0]=2; faces[ 1, 1]=5; faces[ 1, 2]=3
...
floor = pre.rigidPlan(axe1=2.5, axe2=3, axe3=0.1, center=[0.125, 2.1875, -0.1],model=mR3D, material=tdur, color='FLOOR')
